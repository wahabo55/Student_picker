class StudentPicker {
    ...
    generateQRCode() {
        ...
        try {
            // Use the correct QR code library API
            if (typeof qrcode !== 'undefined' && qrcode.QRCode) {
                const qr = qrcode.QRCode(0, qrcode.QRErrorCorrectLevel.M);
                ...
                // Alternative API for the library
                const qr = qrcode(0, 'M');
                qr.addData(currentUrl);
                qr.make();
